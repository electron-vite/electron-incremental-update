...
export interface UpdaterParsedOptions {
...
export interface ResolvedOptions {
  ...
  isBuild: boolean
  /**
   * Project root directory, resolved from vite config or falls back to process.cwd()
   */
  root: string
  /** Entry build options */
  entry: ElectronWithUpdaterOptions['entry']
  /** Main process build options */
  main: ElectronWithUpdaterOptions['main']
  /** Preload build options */
  preload: ElectronWithUpdaterOptions['preload']
  /** Whether to generate sourcemap */
  sourcemap: boolean
  /** Whether to minify the code */
  minify: boolean
  /** Whether to generate version json */
  buildVersionJson: boolean | undefined
  /** Whether to use notBundle plugin */
  notBundleOption: boolean | NotBundleOptions
  isESM: boolean
  finalExternal: (string | RegExp)[]
